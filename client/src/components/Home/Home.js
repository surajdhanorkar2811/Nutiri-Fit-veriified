    ...
    return (
        <div className="p-3 mb-2  ">
            ...
            <div className="container">
                ...
                {/* <!-- into start --> */}
                <div className="row  py-5 valuecard" style={{ backgroundColor: 'rgba(243, 243, 243, 0.777)' }}>
                    <div className="col-sm-6  d-flex flex-column justify-content-center ">
                        ...
                        <span className="py-3 m-2" onClick={() => navigate("/about")} >
                            <button type="button" className="btn btn-primary rmdbut rounded-1 grnbtn ">Read More <img className="redbtn"
                                src={arrow} /> </button>
                        </span>
                ...
                <div className="row  py-5 valuecard " style={{ backgroundColor: 'rgba(243, 243, 243, 0.777)' }}>
                    <div className="col-sm-12  d-flex flex-column justify-content-center text-center">
                        ...
                        <div>
                            <a className="nav-link scrbtn" onClick={() => navigate("/searchlogin")}>
                            ...
                            <div className="col ">
                                <div className="card h-100 border-0 shadow valuecard">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <h5 className="card-title">Mayank Ashteakr</h5>
                                        <p className="card-text">UI UX , Content Writer</p>
                                    </div>
                                </div>
                            </div>
